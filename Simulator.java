        ...
        try{
            ...
            while(Reader.hasNextLine()){
                ...
                if(final_array[0].equals("add")){
                    int num1 = Hash.map.get(final_array[2]).num;
                    int num2 = Hash.map.get(final_array[3]).num;
                    int result = add(num1, num2);
                    Hash.map.get(final_array[1]).num = result;
                    System.out.println(result);
                }else if(final_array[0].equals("li")){
                    int num = Integer.parseInt(final_array[2]);
                    li(Hash.map.get(final_array[1]), num);
                }else if(final_array[0].equals("addi")){
                    int num1 = Hash.map.get(final_array[2]).num;
                    int num2 = Integer.parseInt(final_array[3]);
                    int result = add(num1, num2);
                    Hash.map.get(final_array[1]).num = result;
                }else if(final_array[0].equals("sub")){
                    int num1 = Hash.map.get(final_array[2]).num;
                    int num2 = Hash.map.get(final_array[3]).num;
                    int result = sub(num1, num2);
                    Hash.map.get(final_array[1]).num = result;
                }else if(final_array[0].equals("lw")){
                    int offset = Integer.parseInt(final_array[2]);
                    int r = Hash.map.get(final_array[3]).num;
                    int address = offset + r;
                    int result = (int)Memory.m[address];
                    Hash.map.get(final_array[1]).num = result;
                }else if(final_array[1].equals("sw")){
                    int offset = Integer.parseInt(final_array[2]);
                    int r = Hash.map.get(final_array[3]).num;
                    int address = offset + r;
                    Memory.m[address] = Hash.map.get(final_array[1]).num;
                }
            }
